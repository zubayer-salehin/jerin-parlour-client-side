        ...
        <div className="newslatterBackground px-5">
            <div className='2xl:max-w-7xl mx-auto'>
                <div className='text-secondary text-center pt-20 pb-28'>
                    ...
                    <input style={{ borderRadius: "25px" }} type="text" placeholder="Your Email Address" className="input w-full sm:w-5/12 mr-5 contactInput rounded-3xl" />
                    <button className='btn btn-primary rounded-full text-white font-seimibold capitalize mt-5 sm:mt-0'>Subscribe</button>
                </div>
            </div>
        </div>
    );
