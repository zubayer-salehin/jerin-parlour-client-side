        ...
        <Swiper
            ...
            <SwiperSlide className='relative'>
                ...
                <div className='absolute bannerImagePositionSet'>
                    <h2 className='text-center sm:text-left text-3xl sm:text-5xl font-bold text-primary bannerTitleStyle'>BeautyZone Hair Salon <br /> Creating Beauty</h2>
                    ...
                    <button className='mt-14 sm:mt-0 ml-12 sm:ml-0 px-7 py-3.5 mr-5 bg-primary text-white rounded-sm'>Get A Quote</button>
                    <button className='px-7 py-3.5 bg-teal-500 text-white rounded-sm'>About Us</button>
                </div>
            </SwiperSlide>
            <SwiperSlide className='relative'>
