...
const Team = () => {
    return (
        <div id='team' className='2xl:max-w-7xl mx-auto'>
            <div className='pt-24 pb-20'>
            <h2 className='text-4xl font-bold text-secondary text-center pb-3 leading-tight sm:leading-none'>Our Professional <span className='text-primary'> Team</span></h2>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-4 gap-5 sm:gap-10 px-20 sm:px-24'>
                <div className='team'>
